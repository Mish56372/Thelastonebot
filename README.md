...
- IP сервера
- Ссылка для клонирования бота, в данном случае: 
- `git clone https://github.com/Mish56372/Thelastonebot`
...
- Выполним команду клонирования нашего репозитория, как делали это на своем
  компьютере `git clone https://github.com/Mish56372/Thelastonebot`
